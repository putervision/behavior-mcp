...
async function shutdown(signal: string) {
  ...
  isShuttingDown = true;
  logger.info(`Received ${signal}. Shutting down behavior-mcp...`);
...
async function main() {
  ...
  logger.info(`Starting behavior-mcp server v${version}...`);
  ...
  logger.info('behavior-mcp server connected over stdio.');
}
